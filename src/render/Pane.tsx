  ...
  return (
    ...
    >
      <PaneHeader
        ...
        onWorkspacePopoverOpen={onWorkspacePopoverOpen}
        onWorkspacePopoverClose={onWorkspacePopoverClose}
      />
      <Inspector pane={pane} />
